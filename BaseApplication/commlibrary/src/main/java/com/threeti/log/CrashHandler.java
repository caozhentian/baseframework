...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private boolean handleException(Throwable ex) {
        if (ex == null) {
            LoggerManager.w( "handleException --- ex==null");
            return true;
        }
...
//                    Context.MODE_PRIVATE);
            ...
            LoggerManager.e( "an error occured while writing report file...", e);
        }
        return null;
    }
    ...
    public void collectCrashDeviceInfo(Context ctx) {
        try {
            ...
            LoggerManager.e( "Error while collect package info", e);
        }
        ...
        for (Field field : fields) {
            try {
                ...
                LoggerManager.d(TAG, field.getName() + " : " + field.get(null));

            } catch (Exception e) {
                LoggerManager.e(TAG, "Error while collect crash info", e);
            }
        }
    }
}
